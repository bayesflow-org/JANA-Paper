...
def two_moons_snl(num_simulations_per_round,
                  num_rounds,
                  seed,
                  prior,
                  simulator,
    ...
    for i in range(num_rounds):
        ...
        np.savetxt(f'output/{dir_prefix}snl_post_round{i+1}_seed{seed}.csv',
    ...
    for i in range(num_rounds):
        ...
        np.savetxt(f'output/{dir_prefix}snl_post_pred_round{i+1}_seed{seed}.csv',
...
if __name__ == "__main__":
    ...
    for seed in [2]:  # SNLE is too slow for 1k posterior samples to run 10 repeats
        two_moons_snl(num_simulations_per_round=config.num_simulations_per_round,
